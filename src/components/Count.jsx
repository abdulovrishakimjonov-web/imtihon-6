      ...
      <div className="max-w-[1224px] mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2  mb-16">
          <div
            ...
            className="bg-white rounded-2xl overflow-hidden shadow-md w-140 hover:shadow-2xl transition-all duration-500 cursor-pointer"
            style={{
              transform:
          ...
          >
            <div className="relative  overflow-hidden h-64">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t0 from-black/50 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-500"></div>
            </div>
            <div className="p-6">
          ...
          <div className="flex flex-col gap-6">
            <div
              ...
              onMouseLeave={() => setHoveredBlog(null)}
              className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-500 cursor-pointer flex gap-4"
              style={{
                transform:
                  hoveredBlog === 2 ? "translateX(8px)" : "translateX(0)",
              }}
            >
              <div className="relative overflow-hidden w-60  flex-shrink-2">
                <img
                  src={blog}
                  alt="Headphones"
                  className="w-[280] h-48 object-cover transition-transform duration-700"
                  style={{
              ...
              <div className="p-4 flex-1">
                <h3 className="text-base font-bold text-[#F45E0C] mb-2 hover:text-neutral-400 transition-colors duration-300 line-clamp-1">
            ...
            >
              ...
              <div className="p-4 flex-1">
                <h3 className="text-base font-bold text-gray-900 mb-2 hover:text-blue-600 transition-colors duration-300 line-clamp-1">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div
            ...
            className="gap-4  text-center cursor-pointer transition-all duration-500 flex items-center"
            style={{
              transform:
                hoveredFeature === 1
          ...
          >
            ...
            <h3 className="text-[20px]  text-[#0C0C0C]">
          ...
          <div
            ...
            onMouseLeave={() => setHoveredFeature(null)}
            className="cursor-pointer transition-all duration-500 flex items-center gap-3"
            style={{
              transform:
                hoveredFeature === 2
                  ? "translateY(-12px) scale(1.05)"
          ...
          >
            ...
            <h3 className="text-[20px] text-[#0C0C0C]">Guarantee</h3>
          </div>
          ...
          >
            ...
            <h3 className="text-[20px] text-[#0C0C0C]">24/7 Support</h3>
          </div>
        </div>
      </div>
    </section>
